//+------------------------------------------------------------------+
//| EURUSD_H1_Strategy 2.1.102 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader5 (hedged)
//|    Generated at 04/28/2025 15:55
//| 
//|    Backtested on EURUSD / H1, 2017.01.01 - 2024.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "EURUSD_H1_Strategy_2_1_102";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 101;        //MagicNumber
...
input double InitialCapital = 1000; //InitialCapital (0 means whole account balance). Used in some MM methods.
...
input string FridayCloseTime = "21:55";
input string SundayOpenTime = "22:05";
input string seod = "----------- Exit At End Of Day -----------";
input bool ExitAtEndOfDay = false;
input string EODExitTime = "21:55";

input string seof = "----------- Exit On Friday -----------";
input bool ExitOnFriday = false;
input string FridayExitTime = "21:55";

input string sltr = "----------- Limit Time Range -----------";
input bool LimitTimeRange = true;
input string SignalTimeRangeFrom = "01:05";
input string SignalTimeRangeTo = "21:55";
...
double sqMinDistance = 2.0; //Stop orders min distance from current price
...
#define LINEARREGRESSION_1 0     //iCustom(NULL,0, "SqLinReg", 100, PRICE_CLOSE)
#define LOWEST_1 1     //iCustom(NULL,0, "SqLowest", 50, PRICE_LOW)
#define LOWEST_2 2     //iCustom(NULL,0, "SqLowest", 100, PRICE_HIGH)
#define HIGHEST_1 3     //iCustom(NULL,0, "SqHighest", 50, PRICE_HIGH)
#define HIGHEST_2 4     //iCustom(NULL,0, "SqHighest", 100, PRICE_LOW)
#define EMA_1 5     //iMA(NULL,0, 50, 0, MODE_EMA, PRICE_HIGH)
#define EMA_2 6     //iMA(NULL,0, 20, 0, MODE_EMA, PRICE_HIGH)
#define EMA_3 7     //iMA(NULL,0, 50, 0, MODE_EMA, PRICE_LOW)
#define EMA_4 8     //iMA(NULL,0, 20, 0, MODE_EMA, PRICE_LOW)
...
string sqStrategyName = "EURUSD_H1_Strategy 2.1.102";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((NormalizeDouble((double) sqGetIndicatorValue(LINEARREGRESSION_1, 0, 1), 6) < NormalizeDouble((double) sqClose(NULL,0, 1), 6))
      &&   (sqIsFalling(LOWEST_1, 2, false, 1 + 1, 0)))
      &&   (sqIsFalling(LOWEST_2, 3, true, 1 + 1, 0)));

     ShortEntrySignal = (((NormalizeDouble((double) sqGetIndicatorValue(LINEARREGRESSION_1, 0, 1), 6) > NormalizeDouble((double) sqClose(NULL,0, 1), 6))
      &&   (sqIsRising(HIGHEST_1, 2, false, 1 + 1, 0)))
      &&   (sqIsRising(HIGHEST_2, 3, true, 1 + 1, 0)));

     LongExitSignal = (indyCrossesBelow(EMA_1, EMA_2, 1, 1, 0, 0)
      &&   (sqIsFalling("sqClose(NULL,0, 1)", 3, true, 0 + 1, 0)));

     ShortExitSignal = (indyCrossesAbove(EMA_3, EMA_4, 1, 1, 0, 0)
      &&   (sqIsRising("sqClose(NULL,0, 1)", 3, true, 0 + 1, 0)));
...
//------------------------
...
)
   {
      ...
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_BUY, openPrice, 1, 90.0), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_BUY, openPrice, 1, 100.0), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetExitAfterXBars(_ticket, 100);
      }
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL, openPrice, 1, 90.0), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL, openPrice, 1, 100.0), "Current");
      size = mmLots * mmMultiplier;
...
bool initIndicators(){
   ...
   indicatorHandles[LINEARREGRESSION_1] = iCustom(NULL,0, "SqLinReg", 100, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_1] = iCustom(NULL,0, "SqLowest", 50, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_2] = iCustom(NULL,0, "SqLowest", 100, PRICE_HIGH);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", 50, PRICE_HIGH);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_2] = iCustom(NULL,0, "SqHighest", 100, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[EMA_1] = iMA(NULL,0, 50, 0, MODE_EMA, PRICE_HIGH);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[EMA_2] = iMA(NULL,0, 20, 0, MODE_EMA, PRICE_HIGH);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[EMA_3] = iMA(NULL,0, 50, 0, MODE_EMA, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[EMA_4] = iMA(NULL,0, 20, 0, MODE_EMA, PRICE_LOW);
